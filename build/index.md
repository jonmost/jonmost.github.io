...
<div <a class="button_wrapper">
    <button class="usa-button-big" type="button">Default</button> class="button_wrapper" href="https://acquisition-planning-beta.herokuapp.com" type="button">ReqGen</button>
 </a> </div>
